...
export default function ProductDetailPage() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#0A0A0A] pt-24 pb-28 md:pb-20">
        {/* ─── Breadcrumb ──────────────────────────────────────────────────── */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6">
          ...
          {/* ─── Grid: stacked on mobile, two columns on desktop ─────────────── */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-6 md:gap-y-4 items-start">
            ...
            >
              ...
              {/* ── Desktop CTA — inline, below size selector ─────────────── */}
          ...
          {/* ── CTA Button — mobile floating only ───────────────────────────── */}
          <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 px-4 pb-4 pt-2 bg-gradient-to-t from-black/90 to-transparent">
            <a
              id="btn-whatsapp"
              href={whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center gap-2 gold-gradient text-black font-bold py-3.5 px-4 rounded-xl text-sm tracking-wide shadow-lg hover:opacity-90 active:scale-95 transition-all duration-200 cursor-pointer"
            >
